...
Yingshaoxo: How to use it? Go to `./projects/chargpt`, add `input.txt` traning data (it contains all those text data for your AI), run `chargpt.py` to train, run `show_time.py` to predict.
